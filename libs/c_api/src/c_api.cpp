...
uint64_t xblob_get_capabilities(void) {
    return XBLOB_CAPABILITY_MEDIA_INSPECTION | XBLOB_CAPABILITY_DETERMINISTIC_SCHEDULER |
           ...
           XBLOB_CAPABILITY_DIAGNOSTIC_EXECUTION | XBLOB_CAPABILITY_FRAMEBUFFER_PRESENTATION |
           XBLOB_CAPABILITY_NV2A_GPU | XBLOB_CAPABILITY_XDVDFS_VFS | XBLOB_CAPABILITY_MEDIA_BOOT |
           XBLOB_CAPABILITY_EXPERIMENTAL_TITLE_EXECUTION |
           XBLOB_CAPABILITY_COMPATIBILITY_DIAGNOSTICS | XBLOB_CAPABILITY_NV2A_3D |
           XBLOB_CAPABILITY_USB_OHCI | XBLOB_CAPABILITY_XID_INPUT |
           XBLOB_CAPABILITY_INTERACTIVE_SESSION;
}
